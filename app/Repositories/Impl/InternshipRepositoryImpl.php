...
class InternshipRepositoryImpl extends BaseRepositoryImpl implements InternshipRepository{
    ...
    public function getInternshipById(int $id): ?InternshipModel {
        $query = $this->model::select(
            ...
            'internship_status.description as internship_status_description',
            'internship_status.text_color as internship_status_text_color',
            'internship_status.background_color as internship_status_background_color',
